 ...
 *     '''Performs Gauss-Seidel iterations until convergence
 */
  __pyx_tuple__28 = PyTuple_Pack(16, __pyx_n_s_p, __pyx_n_s_b, __pyx_n_s_dx, __pyx_n_s_tol, __pyx_n_s_max_it, __pyx_n_s_nx, __pyx_n_s_ny, __pyx_n_s_isize, __pyx_n_s_diff, __pyx_n_s_tol_hist_gs, __pyx_n_s_tol_hist_gs_view, __pyx_n_s_p_new_view, __pyx_n_s_pbar, __pyx_n_s_it, __pyx_n_s_i, __pyx_n_s_j); if (unlikely(!__pyx_tuple__28)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__28);
  __Pyx_GIVEREF(__pyx_tuple__28);
  __pyx_codeobj__29 = (PyObject*)__Pyx_PyCode_New(5, 0, 16, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__28, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_csolver_pyx, __pyx_n_s_c_gauss_seidel, 19, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__29)) __PYX_ERR(0, 19, __pyx_L1_error)
